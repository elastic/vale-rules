...
To use the attachment processor within an array of attachments the [foreach processor](https://www.elastic.co/docs/reference/enrich-processor/foreach-processor) is required. This enables the attachment processor to be run on the individual elements of the array.
