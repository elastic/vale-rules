...
In all of the Universal Profiling views, the search bar accepts a filter in the Kibana Query Language [KQL](https://www.elastic.co/docs/explore-analyze/query-filter/languages/kql).
